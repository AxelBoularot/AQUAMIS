...
from dependencies.start_sreen import show_start_screen, SENSOR_DATA_FILE,show_start_screen,phone_video_frame, USE_PHONE_SENSORS, SENSOR_DATA_FILE, phone_video_lock
import cv2
import numpy as np
...
class App:
    def __init__(self):
        ...
        self.button_stop           = Special_button(20, 630, 170, 100, 'STOP', self.font, WHITE, (139,0,0),(255,100,100), self.starting_screen, self.but_stop,"")
        self.button_emergency_stop = Special_button(20, 510, 350, 110, 'EMERGENCY STOP', self.font, WHITE, (139,0,0), (255,100,100), self.starting_screen, self.button_action, 
