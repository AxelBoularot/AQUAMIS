...
class App():
    def __init__(self):
        ...
        # remonter les touches : valeur y plus petite -> plus haut sur l'interface
        y_row1 = BASE_HEIGHT - 180   # anciennement -120, remonté de 60px
        # row2 (centered under row1)
        total_w_row2 = len(labels_row2) * btn_w + (len(labels_row2) - 1) * gap
        start_x_row2 = BASE_WIDTH // 2 - total_w_row2 // 2
        y_row2 = BASE_HEIGHT - 108   # anciennement -48, remonté de 60px
