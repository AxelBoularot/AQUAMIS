...
def main():
    ...
    while running:
        ...
        button_stop.draw(virtual_screen, font)
    # Draw the virtual UI onto the real window (scaled)
    # (existing code blits virtual_screen -> screen below)
    # Draw menu bar as an overlay on the real window AFTER scaling
